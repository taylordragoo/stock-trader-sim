...
function Contact() {
    ...
    return (
        <div className="grid card grid-nogutter" style={{ columnGap: '2rem', rowGap: '2rem' }}>
            ...
            <div className="col-12 mt-3 h-20rem border-1 surface-border p-0 w-full bg-cover border-round" style={{ backgroundImage: `url('/demo/images/contact/map-${layoutConfig.colorScheme === 'light' ? 'light' : 'dark'}.svg')` }}></div>
