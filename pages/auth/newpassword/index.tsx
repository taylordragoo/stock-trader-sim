                ...
                <div className="border-1 surface-border surface-card border-round py-7 px-4 md:px-7 z-1">
                    ...
                    <div className="flex flex-column">
                        <span className="p-input-icon-left w-full mb-4">
                            ...
                            <Password id="password" className="w-full" type="text" inputClassName="w-full md:w-25rem" placeholder="Password" toggleMask inputStyle={{ paddingLeft: '2.5rem' }} />
                        </span>
                        <span className="p-input-icon-left w-full mb-4">
                            <i className="pi pi-lock z-2"></i>
                            <Password id="password2" className="w-full" type="text" inputClassName="w-full md:w-25rem" placeholder="Repeat Password" toggleMask feedback={false} inputStyle={{ paddingLeft: '2.5rem' }} />
                        </span>
